========================================================================
    ACTIVE TEMPLATE LIBRARY : WMFPreview Project Overview
========================================================================

AppWizard has created this WMFPreview project for you to use as the starting point for
...
WMFPreview.h
    ...
    items defined in WMFPreview.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named WMFPreview.pch and a precompiled types file named StdAfx.obj.
